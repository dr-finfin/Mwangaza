...
const ProfileView = () => {
  ...
  return (
    <div className="animate-fade-in max-w-2xl mx-auto">
      ...
      {/* Profile Card */}
      <div
        className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 
          ...
          <div className="-mt-12 mb-6 flex items-end justify-between">
            <div className="relative">
              {profile?.avatar_url ? (
                ...
                <div
                  className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-700 
              ...
              {/* Online dot */}
              <div
                className="absolute -bottom-1 -right-1 w-5 h-5 bg-emerald-500 
          ...
          {editing ? (
                ...
                <div className="grid grid-cols-5 gap-2">
                  {GRADES.map((g) => (
                    <button
                      key={g.id}
                      onClick={() =>
                        setForm((prev) => ({ ...prev, selected_grade: g.id }))
                      }
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-3 flex-wrap">
                ...
                <span
                  className="px-3 py-1 bg-gold-100 dark:bg-gold-900/20 text-gold-600 
                                 dark:text-gold-400 text-xs font-semibold rounded-full"
                >
                  🔥 {profile?.streak_days || 0} day streak
                </span>
                <span
                  className="px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 
        ...
        <div className="divide-y divide-gray-50 dark:divide-gray-700">
          {[
            ...
            <div key={i} className="flex items-center gap-4 px-6 py-4">
              <div
                className="w-9 h-9 bg-gray-100 dark:bg-gray-700 rounded-xl 
      ...
      {/* Danger Zone */}
      <div
        className="bg-white dark:bg-gray-800 rounded-3xl border border-red-100 
      ...
      >
        ...
        <div className="px-6 py-4">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
            Signing out will end your session. Your progress is safely saved to
            the cloud.
          </p>
          <button
            onClick={() => {
