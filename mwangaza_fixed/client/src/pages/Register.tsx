  ...
  return (
    <div className="min-h-screen bg-blue-50 dark:bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans transition-colors duration-200">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-xl font-medium text-blue-800 dark:text-blue-400">Start Your Journey</h2>
        <p className="mt-2 text-slate-600 dark:text-slate-400">Create an account to track your progress</p>
      </div>
