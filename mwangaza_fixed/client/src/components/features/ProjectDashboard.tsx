...
export default function ProjectDashboard() {
  ...
  const renderContent = () => {
        ...
        <div>
          ...
          <div className="space-y-3">
            {subTopicsWithProjects.map((sub) => (
              <div 
                key={sub.name} 
                className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm cursor-pointer hover:bg-yellow-100 dark:hover:bg-yellow-900/20 transition border-l-4 border-transparent hover:border-yellow-400 dark:hover:border-yellow-500"
    ...
    return (
      <>
        <h1 className="text-3xl font-bold text-blue-900 dark:text-gray-100 mb-6">Projects: Select a Category</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
  ...
  return <div className="p-8 bg-blue-50 dark:bg-gray-900 min-h-screen text-slate-900 dark:text-slate-100 transition-colors duration-200">{renderContent()}</div>;
}
